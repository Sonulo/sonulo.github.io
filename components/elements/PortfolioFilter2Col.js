        ...
        <>
            ...
            <div className="project_container clearfix" style={{ position: 'relative', height: 776 }}>
                <div className="row clearfix">
                    <div className="project-wrapper grid-item col-lg-6 col-md-6 col-sm-12 col-xs-12 project_category-coaching" style={{ position: 'absolute', left: 0, top: 0 }}>
                    ...
                    <div className="project-wrapper grid-item col-lg-6 col-md-6 col-sm-12 col-xs-12 project_category-human-resources" style={{ position: 'absolute', left: '373.328px', top: 0 }}>
                        <div className="project_box style_two">
                            <div className="entry-thumbnail image">
                    ...
                    <div className="project-wrapper grid-item col-lg-6 col-md-6 col-sm-12 col-xs-12 project_category-leadership" style={{ position: 'absolute', left: '746.656px', top: 0 }}>
                        <div className="project_box style_two">
                            <div className="entry-thumbnail image">
                    ...
                    <div className="project-wrapper grid-item col-lg-6 col-md-6 col-sm-12 col-xs-12 project_category-pre-sale" style={{ position: 'absolute', left: 0, top: 388 }}>
                        <div className="project_box style_two">
                            <div className="entry-thumbnail image">
                    ...
                    <div className="project-wrapper grid-item col-lg-6 col-md-6 col-sm-12 col-xs-12 project_category-recruiting" style={{ position: 'absolute', left: '373.328px', top: 388 }}>
                        <div className="project_box style_two">
                            <div className="entry-thumbnail image">
                    ...
                    <div className="project-wrapper grid-item col-lg-6 col-md-6 col-sm-12 col-xs-12 project_category-values" style={{ position: 'absolute', left: '746.656px', top: 388 }}>
                        <div className="project_box style_two">
                            <div className="entry-thumbnail image">
