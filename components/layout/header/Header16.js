...
export default function Header16({ handleSearch, handleContactPopup, handleMobileMenu, handleCart }) {
    return (
        <>
                            ...
                            <div className="header_top_inner">
                                ...
                                <div className="top_right text-right">
                                    <ul className="contact_info_two">
                                        <li className="single">
                                            <p> <span className="icon-telephone" /> <Link href="tel:+98 060 712 34">+98
                                                060 712
                                                34</Link>
                                            </p>
                                        </li>
