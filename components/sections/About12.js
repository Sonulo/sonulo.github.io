                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div className="icon_carousel_box_all">
                                <Swiper {...swiperOptions} className="owl_dots_block theme_carousel">
                                    <SwiperSlide className="icon_caro type_one">
                                        <div className="icon">
                                            <img src="/assets/images/shooting-target.png" className="img-fluid svg_image" alt="icon png" />
                                        </div>
                                        <div className="text">
                                            <h2>
                                                <Link href="#">
                                    ...
                                    <SwiperSlide className="icon_caro type_one">
                                        <div className="icon">
                                            <img src="/assets/images/focus.png" className="img-fluid svg_image" alt="icon png" />
                                        </div>
                                        <div className="text">
                                            <h2>
                                                <Link href="#">
                            ...
                            <div className="image_box_new type_two clearfix pd_left_40 md_pd_left_zero">
                                <div className="image_box_inner">
                                    <div className="image one">
                                        <img src="/assets/images/about/about-8.jpg" className="img-fluid" alt="img" />
                                    ...
                                    <div className="image two">
                                        <img src="/assets/images/about/about-10.jpg" className="img-fluid" alt="img" />
                                    </div>
                                </div>
                            </div>
                        </div>
