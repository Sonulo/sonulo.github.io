...
export default function Contact7() {
    return (
        <>
            <section className="contact-section bg_op_1" style={{ backgroundImage: 'url(/assets/images/home-10-contact.jpg)' }}>
                {/*===============spacing==============*/}
                        ...
                        <div className="col-xl-6 col-lg-12 mb-sm-5 mb-md-5 mb-lg-5 mb-xl-0">
                            <div className="title_all_box style_one light_color">
                                <div className="title_sections">
                                    <div className="before_title color_white">The Steps of</div>
                            ...
                            <div className="content_box_cn style_one light_color">
                                <div className="txt_content">
                                    <h3><Link href="#" className="color_white">Identifiying the Needs</Link ></h3>
                            ...
                            <div className="content_box_cn style_one light_color">
                                <div className="txt_content">
                                    <h3><Link href="#" className="color_white">Preparing Job Description</Link ></h3>
                            ...
                            <div className="content_box_cn style_one light_color">
                                <div className="txt_content">
                                    <h3><Link href="#" className="color_white">Find Talented Candidate</Link ></h3>
                            ...
                            <div className="content_box_cn style_one light_color">
                                <div className="txt_content">
                                    <h3><Link href="#" className="color_white">Screening &amp; Shortlisting</Link ></h3>
