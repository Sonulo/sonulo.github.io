                ...
                <div className="container">
                        ...
                        <div className="col-lg-6">
                            <div className="title_all_box style_one dark_color">
                                <div className="title_sections">
                                    ...
                                    <div className="title">A Glance of Our Work</div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6">
                    ...
                    <div className="row">
                            ...
                            <div className="project_box type_one">
                                <div className="image_box ">
                                    ...
                                    <div className="overlay">
                                        <Link data-fancybox="gallery" className="zm_btn" href="/assets/images/projects/project-6-img.jpg">
                                ...
                                <div className="content_box">
                                    <div className="content_box_inner">
                                        ...
                                        <p>
                                            <Link href="/project-details" className="cat"> Human Resources</Link >,
                                            <Link href="/project-details" className="cat">Recruiting</Link >
                                        </p>
                                        <Link href="/project-details" className="read_more_link">
                        ...
                        <div className="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                            <div className="project_box type_one">
                                <div className="image_box ">
                                    ...
                                    <div className="overlay">
                                        <Link data-fancybox="gallery" className="zm_btn" href="/assets/images/projects/project-5-img.jpg">
                                            <span className="icon-plus zoom_icon" />
                                        </Link >
                                    </div>
                                </div>
                                <div className="content_box">
                                    <div className="content_box_inner">
                                        <h2 className="entry-title"><Link href="#">Six Essential Steps To Writing Successful
                                            Job</Link ></h2>
                                        <p> <Link href="/project-details" className="cat">Coaching</Link >,
                                            <Link href="/project-details" className="cat">Values</Link ></p>
                                        <Link href="#" className="read_more_link"><span className="icon-arrow-right" /></Link >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                            <div className="project_box type_one">
                                <div className="image_box ">
                                    <img src="/assets/images/projects/project-4-img.jpg" className="img-fluid" alt="mg" />
                                    <div className="overlay">
                                        <Link data-fancybox="gallery" className="zm_btn" href="/assets/images/projects/project-4-img.jpg">
                                            <span className="icon-plus zoom_icon" />
                                        </Link >
                                    </div>
                                </div>
                        ...
                        <div className="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                            <div className="project_box type_one">
                                <div className="image_box ">
                                    ...
                                    <div className="overlay">
                                        <Link data-fancybox="gallery" className="zm_btn" href="/assets/images/projects/project-3-img.jpg">
                                            <span className="icon-plus zoom_icon" />
                                        </Link >
                                    </div>
                                </div>
                                <div className="content_box">
                                    <div className="content_box_inner">
                                        <h2 className="entry-title"><Link href="/project-details">Essential Steps to
                                            Writing Job
                                            Description</Link ></h2>
                                        <p> <Link href="/project-details" className="cat">Human Resources</Link >, <Link href="/project-details" className="cat">Recruiting</Link ></p>
                                        <Link href="/project-details" className="read_more_link"><span className="icon-arrow-right" /></Link >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                            <div className="project_box type_one">
                                <div className="image_box ">
                                    ...
                                    <div className="overlay">
                                        <Link data-fancybox="gallery" className="zm_btn" href="/assets/images/projects/project-2-img.jpg">
                                            <span className="icon-plus zoom_icon" />
                                        </Link >
                                    </div>
                                </div>
                        ...
                        <div className="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                            <div className="project_box type_one">
                                <div className="image_box ">
                                    <img src="/assets/images/projects/project-1-img.jpg" className="img-fluid" alt="img" />
                                    <div className="overlay">
                                        <Link data-fancybox="gallery" className="zm_btn" href="/assets/images/projects/project-1-img.jpg">
                                            <span className="icon-plus zoom_icon" />
                                        </Link >
                                    </div>
                                </div>
